  ...
  return (
    ...
    viewport={{ once: true }}
     className='min-h-[80vh] text-center pt-14 mb-10 px-4'>
      ...
      <h1 className='text-center text-2xl sm:text-3xl font-medium mb-6 sm:mb-10'>Choose the plan</h1>

      <div className='flex flex-wrap justify-center gap-6 text-left'>
        {plans.map((item, index) => (
          <div key={index} 
          className='bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-600 hover:scale-[1.03] transition-all duration-500 w-full sm:w-auto'>
            <img  width={40} src= {assets.logo_icon} alt=""/>
            <p className='mt-3 mb-1 font-semibold text-lg sm:text-base'>{item.id}</p>
