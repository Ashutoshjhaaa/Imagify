...
const Header = () => {
  ...
  return (
    ...
    >
        ...
        <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 py-1 rounded-full border border-natural-500'
    ...
    transition={{ delay: 0.2, duration:0.8 }}
        >
            ...
            <p>Best text to image AI generator</p>
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ default:{duration:0.5}, opacity: { delay: 0.8, duration: 1.5 } }}
        >
            Generate Images
